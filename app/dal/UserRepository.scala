...
class UserRepository @Inject()( dbConfigProvider: DatabaseConfigProvider )( implicit ec: ExecutionContext ) {
   ...
   */
  /*def filterQuery( id: Int ) : TableQuery[Users] = {
  ...
  /**
   * Update with filed input
   */
  def update( id: Int, phone: String, name: String, gender: Char, facebook: String,
              twitter:  String,
              linkedIn: String,
    ...
    val q = for (
      ...
      u.phone,
      u.name,
      u.gender, u.facebook, u.twitter, u.linkedIn, u.wechat )
